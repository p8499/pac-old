        ...
        <ol class="breadcrumb">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="active">
                        <a href="${baseUrl}uniques?path=${pac:parent(requestScope.path)}">
                            Uniques</a>
                    </li>
                    <li>
                ...
                <ul class="dropdown-menu" role="menu">
                    <c:forEach items="${pac:read(sessionScope.json,pac:parent(requestScope.path))}"
                        ...
                        <li<c:if test="${moduleStatus.index==pac:id(requestScope.path)}">
                            class="active"</c:if>>
                            <a href="${baseUrl}unique?path=${pac:parent(requestScope.path)}[${moduleStatus.index}]">
        ...
        <div class="col-sm-9">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form onsubmit="event.preventDefault();$.ajax({url:'${baseUrl}unique?path=${requestScope.path}',type:'PUT',data:{item:$('#item').val(),key: $('#key').is(':checked'),serial: $('#serial').is(':checked')},success:function(response){window.location.reload();}});">

        ...
        <ol class="breadcrumb">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="active">
                        <a href="/envAndroid?path=${requestScope.path}">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form data-toggle="validator"
                          onsubmit="event.preventDefault();$.ajax({url:'/envAndroid?path=${requestScope.path}',type:'PUT',data:{app:$('#app').val(),packageBase:$('#packageBase').val(),packageBean:$('#packageBean').val(),packageMask:$('#packageMask').val(),packageView:$('#packageView').val(),packageStub:$('#packageStub').val()},success:function(response){window.location.reload();}});">

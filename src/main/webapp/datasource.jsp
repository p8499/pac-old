        ...
        <ol class="breadcrumb">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li class="active">
                        <a href="${baseUrl}envJtee?path=${pac:parent(pac:parent(requestScope.path))}">
                            J2EE Environment</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="${baseUrl}modules?path=${pac:parent(pac:parent(pac:parent(requestScope.path)))}.modules">
                            Modules</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="${baseUrl}datasources?path=${pac:parent(requestScope.path)}">Data Sources</a>
            </li>
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <c:forEach items="${pac:read(sessionScope.json,pac:parent(requestScope.path))}" var="datasource"
                        ...
                        <li<c:if test="${datasourceStatus.index==pac:id(requestScope.path)}">
                            class="active"</c:if>>
                            <a href="${baseUrl}datasource?path=${pac:parent(requestScope.path)}[${datasourceStatus.index}]">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form data-toggle="validator"
                          onsubmit="event.preventDefault();$.ajax({url:'${baseUrl}datasource?path=${requestScope.path}',type:'PUT',data:{id:$('#id').val(),databaseType:$('#databaseType').val(),url:$('#url').val(),username:$('#username').val(),password:$('#password').val()},success:function(response){window.location.reload();}});">

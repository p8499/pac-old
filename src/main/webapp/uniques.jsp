        ...
        <ol class="breadcrumb">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="active">
                        <a href="/uniques?path=${requestScope.path}">
                            Uniques</a>
                    </li>
                    <li>
                ...
                <div class="panel-body">
                    <table class="table table-hover">
                        ...
                        <c:forEach items="${requestScope.target}" var="unique" varStatus="moduleStatus">
                            ...
                            <a href="/unique?path=${requestScope.path}[${moduleStatus.index}]">${pac:join(",",unique.items)}</a></span>
    ...
    <div class="modal fade" id="post" aria-labelledby="post_label" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form onsubmit="event.preventDefault();$.ajax({url:'/uniques?path=${requestScope.path}',type:'POST',data:{item:$('#item').val(),key: $('#key').is(':checked'),serial: $('#serial').is(':checked')},success:function(response){window.location.reload();}});">

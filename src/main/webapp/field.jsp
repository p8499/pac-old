    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li class="active">
                        <a href="/fields?path=${pac:parent(requestScope.path)}">
                            Fields</a>
                    </li>
                    <li>
                ...
                <ul class="dropdown-menu" role="menu">
                    <c:forEach items="${pac:read(sessionScope.json,pac:parent(requestScope.path))}"
                        ...
                        <li<c:if test="${moduleStatus.index==pac:id(requestScope.path)}">
                            class="active"</c:if>>
                            <a href="/field?path=${pac:parent(requestScope.path)}[${moduleStatus.index}]">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <button class="btn btn-link" type="button">
                        <a href="/special?path=${requestScope.path}.special">Special</a>
                    </button>
                    <button class="btn btn-link" type="button">
                        <a href="/values?path=${requestScope.path}.values">Values</a>
                    </button>
                </div>
            </div>
        </div>
